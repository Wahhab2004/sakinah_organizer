...
export default function Footer() {
	return (
		<footer className="bg-[#302C29] text-white py-10 px-6 md:px-10 w-full relative z-40" id="contact">
			<div className="text-[#E1CD9F]/80 max-w-[1400px] mx-auto mb-20">
				...
				<div className="flex flex-col lg:flex-row justify-between mt-10 gap-10">
						...
						<div className="flex gap-4 items-center">
							...
							<div>
								...
								<Link href="https://wa.me/6281225400933" target="_blank">
									<p className="text-sm">+62 812 2540 0933</p>
								</Link>
							</div>
						</div>
					...
					<div className="flex flex-col md:flex-row justify-center items-center md:items-start gap-10 ">
						...
						{/* Information */}
						<div className="flex flex-col gap-4 items-center w-[256px]">
							<h2 className="text-xl font-semibold text-center">Information</h2>
							<div className="flex gap-8 justify-center font-medium">
								<ul className="list-disc text-sm leading-6">
									<li>About Us</li>
									<li>Service</li>
			...
			{/* Footer Bottom */}
			<div className="flex justify-center items-center w-full h-[80px] bg-[#383533] mt-10 absolute bottom-0 left-0 right-0">
				<h2 className="italic font-semibold text-center text-base md:text-xl text-[#8B816F]">

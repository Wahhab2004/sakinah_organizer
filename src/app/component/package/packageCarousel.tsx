				...
				{packages.map((pkg, idx) => (
					<div key={idx} className="flex-shrink-0 w-full">
						...
						>
							...
							{/* Expandable content dengan tinggi dinamis */}
							{expandedIndex === idx && (
                <div
                  className="accordion-content w-full overflow-hidden transition-max-height duration-500 ease-in-out"
                  style={{
                    maxHeight: expandedIndex === idx ? "1000px" : "0", // Tinggi maksimum disesuaikan lebih besar
                    paddingTop: expandedIndex === idx ? "1rem" : "0",
                  }}
                >
